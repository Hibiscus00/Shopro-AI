...
const AI_TOOLS = [
  ...
  },
  {
    ...
    path: '/knowledge',
    label: 'Prompt知识库',
    desc: '整合并提炼优质 Prompt，智能提效脚本与文案写作',
    icon: BookOpen,
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl md:text-2xl font-bold text-foreground text-balance">7+AI工具箱</h1>
